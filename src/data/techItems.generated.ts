...
export const generatedTechItems: TechItem[] = [
  ...
  },
  {
    "id": "cspm",
    "name": "cspm",
    "categoryId": "host-system-defense",
    "tags": [],
    "description": "",
    "difficulty": "low",
  ...
  },
  {
    "id": "cdn",
    "name": "cdn",
    "categoryId": "network-app-defense",
    "tags": [],
    "description": "",
    "difficulty": "low",
  ...
  },
  {
    ...
    "description": "使用 iptables TPROXY + 策略路由，实现真正全局透明代理，解决终端应用不走系统代理的难题。",
    "difficulty": "medium",
    "path": "02_网络隐匿/隐匿_透明代理-TPROXY实战.md",
    "coreFunction": "详情请查看内部文档",
    "defenseMechanism": "详情请查看内部文档",
    "vulnerabilities": "详情请查看内部文档",
    "principle": "加载中...",
